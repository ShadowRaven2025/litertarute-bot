...
try:
    ...
    print("✅ Модуль python-telegram-bot доступен")
except ImportError as e:
    TELEGRAM_AVAILABLE = False
    print(f"❌ Модуль python-telegram-bot не установлен: {e}")
    exit(1)
...
class BookBot:
    ...
    def handle_recommend(self, user_id: int) -> str:
        ...
        return (
            ...
            "*Доступные жанры:* Фэнтези, Классика, Приключения, Научная фантастика, Детектив, Антиутопия, Мистика, Сатира, Психологический роман"
        )
...
# Обработчики для Telegram (асинхронные)
